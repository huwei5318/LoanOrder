...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private CircularProgressView pull_to_refresh_header_progressbar;
    /**旋转的动画*/
   // private Animation mRotateAnimation;
    ...
    private void init(Context context) {
       ...
       // mArrowImageView = (ImageView) findViewById(R.id.pull_to_refresh_header_arrow);
        ...
        pull_to_refresh_header_progressbar=(CircularProgressView) findViewById(R.id.pull_to_refresh_header_progressbar);
        pull_to_refresh_header_progressbar.setVisibility(View.VISIBLE);
        pull_to_refresh_header_progressbar.startAnimation();
