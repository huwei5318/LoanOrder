...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_btqdsuccess:
                new ActionSheetDialog(ListDetailsQdActivity.this)
                        .builder()
                        .setTitle("请选择操作")
                        .setCancelable(false)
            ...
            case R.id.btn_btqd:
                ...
                OkHttpUtils
                        .postString()
                        .url(ConstantUrl.Firstqddetailsurl)
                                        ...
                                        OkHttpUtils
                                                ...
                                                .execute(new StringCallback() {
                                                    ...
                                                    public void onResponse(String response, int id) {
                                                        ...
                                                        OrderBean orderBean = new Gson().fromJson(response, OrderBean.class);
                                                        ToastUtils.showToastGravityCenter(orderBean.getMsg());
                                                        ListDetailsQdActivity.this.finish();
                                                    }
    ...
    private void showInputimage() {
        View contentView = LayoutInflater.from(ListDetailsQdActivity.this).inflate(R.layout.pop_window, null);
        ...
        simpleDraweeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PictureSelector.create(ListDetailsQdActivity.this)
        ...
        //在底部显示
        popWindow.showAtLocation(ListDetailsQdActivity.this.findViewById(R.id.rela), Gravity.BOTTOM, 0, 0);
    }
