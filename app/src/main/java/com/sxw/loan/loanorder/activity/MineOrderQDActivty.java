...
public class MineOrderQDActivty extends BaseActivity {
...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (IDuser.equals(firstDetailsBean.getOrder().getJlId())) {
                            ...
                            if (firstDetailsBean.getOrder().getJfAmount() != 0) {
                                change.setText(firstDetailsBean.getOrder().getJAmount() + "积分");
                            } else {
                                change.setText("0积分");
                            }
                        }
    ...
    @OnClick({R.id.orderusertel,R.id.btn_tel, R.id.btn_btqd, R.id.btn_back, R.id.btn_hoildfild, R.id.btn_btqdsuccess, R.id.btn_faild})
