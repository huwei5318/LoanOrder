...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_btqdsuccess:
                new ActionSheetDialog(BtTxQdDetailsActivity.this)
                        .builder()
                        .setTitle("请选择操作")
                        .setCancelable(false)
    ...
    private void showInputimage() {
        View contentView = LayoutInflater.from(BtTxQdDetailsActivity.this).inflate(R.layout.pop_window, null);
        ...
        simpleDraweeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PictureSelector.create(BtTxQdDetailsActivity.this)
        ...
        //在底部显示
        popWindow.showAtLocation(BtTxQdDetailsActivity.this.findViewById(R.id.rela), Gravity.BOTTOM, 0, 0);
    }
