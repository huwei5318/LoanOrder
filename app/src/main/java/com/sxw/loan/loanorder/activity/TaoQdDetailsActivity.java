...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
    ...
    protected void onViewClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_btqdsuccess:
                new ActionSheetDialog(TaoQdDetailsActivity.this)
                        .builder()
                        .setTitle("请选择操作")
                        .setCancelable(false)
            ...
            case R.id.btn_btqd:
                ...
                OkHttpUtils
                        .postString()
                        .url(ConstantUrl.tdqdqdupdataurl)
    ...
    private void showInputimage() {
        View contentView = LayoutInflater.from(TaoQdDetailsActivity.this).inflate(R.layout.pop_window, null);
        ...
        simpleDraweeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PictureSelector.create(TaoQdDetailsActivity.this)
        ...
        //在底部显示
        popWindow.showAtLocation(TaoQdDetailsActivity.this.findViewById(R.id.rela), Gravity.BOTTOM, 0, 0);
    }
